...
func MakeGRPCServer(endpoints controller.Endpoints) pb.AddServer {
	return &grpcServer{
...
func DecodeGRPCSumRequest(_ context.Context, request interface{}) (interface{}, error) {
	...
	return controller.SumRequest{int(req.A), int(req.B)}, nil
}
...
func EncodeGRPCSumRequest(_ context.Context, request interface{}) (interface{}, error) {
	req := request.(controller.SumRequest)
...
func EncodeGRPCSumResponse(_ context.Context, response interface{}) (interface{}, error) {
	resp := response.(controller.SumResponse)
...
func DecodeGRPCConcatResponse(_ context.Context, response interface{}) (interface{}, error) {
	...
	return controller.ConcatResponse{resp.V}, nil
}
